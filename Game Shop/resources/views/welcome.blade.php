...
<head>
  ...
  <title>Foxic HTML Template - Index Page - Games</title>
...
<body class="has-squared-btns has-loader-bg equal-height has-btn-not-upper">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-auto hdr-logo">
            <a href="index.html" class="logo"><img srcset="images/skins/games/logo-games.png 1x, images/skins/games/logo-games2x.png 2x" alt="Logo"></a>
          </div>
          <!--navigation-->
          ...
          <div class="row">
            ...
            <div class="hdr-nav hide-mobile nav-holder">
              ...
              <ul class="mmenu mmenu-js">
                ...
                <li class="mmenu-item--mega"><a href="collections.html"><span>GAMES<span class="menu-label">SKIN</span></span></a>
                        ...
                        <div class="mmenu-left width-25">
                          <div class="mmenu-bnr-wrap">
                            <a href="product.html" class="image-hover-scale image-container w-100" style="padding-bottom: 102.91%">
                              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/skins/games/megamenu-game-banner.png" class="lazyload fade-up" alt="Banner">
                            </a>
                          </div>
                        </div>
                ...
                <li><a href="#buytheme"><span class="custom-color">BUY THEME</span></a></li>
              </ul>
              <!--/mmenu-->
            </div>
            <!--//navigation-->
  ...
  <div class="page-content">
      ...
      <div class="container bnslider-wrapper video-section">
        <div class="video-section-wrapper bnslider keep-scale" data-start-width="1920" data-start-height="750" data-start-mwidth="800" data-start-mheight="680" data-desktop-height="775" data-mobile-height="375">
                ...
                <div class="bnslider-text-content txt-middle txt-center txt-middle-m txt-center-m">
                  <div class="bnslider-text-content-flex " style="padding-top: 85.85px;">
                    <div class="bnslider-vert " style="padding: 0px">
                      <div class="bnslider-text order-1 mt-0 bnslider-text--lg text-center data-ini" data-fontcolor="#ffffff" data-fontweight="900" data-fontline="1.00" data-otherstyle="letter-spacing: .1em">YOUTUBE VIDEO</div>
                      <div class="btn-wrap text-center  order-4 mt-md">
                        <a href="/collections/games" target="" class="btn js-video-slider-play btn--lg">Shop now</a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="video-control__play-wrapper">
            <div class="video-control video-control__pause mb-2 d-block" data-id="001" aria-live="polite" aria-pressed="false" data-controls="Video-001"><span class="video-stop"><i class="icon-play"></i></span><span class="video-play">
                <div class="video__loader foxic-loader"></div><i class="icon-pause"></i>
              </span></div>
          </div>
        </div>
      </div>
        ...
        <div class="row bnr-grid no-gutters">
            ...
            <div class="bnr-wrap d-flex align-items-center h-100 bnr-1586628920521-0">
              <div class="bnr custom-caption image-hover-scale image-hover-scale--slow bnr--middle bnr--center" data-fontratio=5.9>
                <div class="bnr-img  image-container" style="padding-bottom: 38.933%">
                  <img data-srcset="images/skins/games/banner-games-01.png" class="lazyload fade-up" alt="">
                </div>
                <div class="bnr-caption" style="padding: 4% 4%; width: 100%;">
                  <div class="bnr-text3 mt-0 order-1" style="font-size:0.15em; font-weight:700; line-height:1em">2 0 2 0</div>
                  <div class="bnr-text3 mt-xs order-2 " style="font-size:0.4em; font-weight:800; line-height:1em;">CALL OF LIFE</div>
                  <div class="bnr-text3 mt-xs order-2 " style="font-size:0.2em; font-weight:500; line-height:1em;">Last day, last hope</div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-18 col-sm-6">
            <div class="bnr-wrap d-flex align-items-center h-100 bnr-1586628920521-1">
              <div class="bnr custom-caption image-hover-scale image-hover-scale--slow bnr--middle bnr--center" data-fontratio=5.9>
                <div class="bnr-img  image-container" style="padding-bottom: 38.933%">
                  <img data-srcset="images/skins/games/banner-games-02.png" class="lazyload fade-up" alt="">
                </div>
                <div class="bnr-caption" style="padding: 4% 4%; width: 100%;">
                  <div class="bnr-text3 mt-0 order-1" style="font-size:0.15em; font-weight:700; line-height:1em">2 0 2 0</div>
                  <div class="bnr-text3 mt-xs order-2 " style="font-size:0.4em; font-weight:800; line-height:1em;">URMOR 5</div>
                  <div class="bnr-text3 mt-xs order-2 " style="font-size:0.2em; font-weight:500; line-height:1em;">Show your WARFACE</div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-18 col-sm-6">
            <div class="bnr-wrap d-flex align-items-center h-100 bnr-1586628920521-2">
              <div class="bnr custom-caption image-hover-scale image-hover-scale--slow bnr--middle bnr--center" data-fontratio=5.9>
                <div class="bnr-img  image-container" style="padding-bottom: 38.933%">
                  <img data-srcset="images/skins/games/banner-games-03.png" class="lazyload fade-up" alt="">
                </div>
                <div class="bnr-caption" style="padding: 4% 4%; width: 100%;">
                  <div class="bnr-text3 mt-0 order-1" style="font-size:0.15em; font-weight:700; line-height:1em">2 0 2 0</div>
                  <div class="bnr-text3 mt-xs order-2 " style="font-size:0.4em; font-weight:800; line-height:1em;">ENEMY FIRE</div>
                  <div class="bnr-text3 mt-xs order-2 " style="font-size:0.2em; font-weight:500; line-height:1em;">Shoot First</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="holder">
      <div class="container">
        <div class="title-wrap text-center">
          <h2 class="h1-style">TOP WORLD GAMES</h2>
            ...
            <div class="prd-inside">
              ...
              <div class="prd-info">
                <div class="prd-info-wrap">
                  ...
                  <div class="prd-tag"><a href="#">FOXic</a></div>
                  <h2 class="prd-title"><a href="product.html">The Game</a></h2>
    ...
    <div class="holder global_width">
      <div class="container">
        <div class="title-wrap text-center">
          <h2 class="h1-style">GAMES OF THE YEAR</h2>
        </div>
    ...
    <div class="holder holder-mt-medium">
      <div class="container">
        <div class="title-with-arrows">
          <h2 class="h1-style"><a href="blog.html" title="View all">HOTTEST GAMES NEWS</a></h2>
          <div class="carousel-arrows"></div>
        </div>
        <div class="post-prws post-prws-carousel post-prws-carousel--single js-post-prws-carousel" data-slick='{"slidesToShow": 2, "responsive": [{"breakpoint": 1200,"settings": {"slidesToShow": 2}},{"breakpoint": 768,"settings": {"slidesToShow": 1}},{"breakpoint": 480,"settings": {"slidesToShow": 1}}]}'>
          <div class="post-prw">
            <div class="row vert-margin-middle">
              ...
              <div class="post-prw-text col-sm-9">
                <h4 class="post-prw-title"><a href="#">This Weeks Snapshots</a></h4>
                <div class="post-prw-links">
                  <div class="post-prw-date"><i class="icon-calendar1"></i><span>November 17, 2020</span></div>
                </div>
                <div class="post-prw-teaser">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna</div>
          ...
          <div class="post-prw">
            <div class="row vert-margin-middle">
              ...
              <div class="post-prw-text col-sm-9">
                <h4 class="post-prw-title"><a href="#">New Online Missions</a></h4>
                <div class="post-prw-links">
                  <div class="post-prw-date"><i class="icon-calendar1"></i><span>November 17, 2020</span></div>
                </div>
                <div class="post-prw-teaser">Nullam quis hendrerit nisi. Donec porta hendrerit sollicitudin. Vestibulum elit tortor, commodo in iaculis quis, imperdiet non eros</div>
                <div class="post-prw-btn">
                  <a href="#" class="btn btn--md">Read More</a>
                </div>
              </div>
          ...
          <div class="post-prw">
            <div class="row vert-margin-middle">
              ...
              <div class="post-prw-text col-sm-9">
                <h4 class="post-prw-title"><a href="#">Fusce erat arcu, rhoncus sit amet convallis eu, laoreet ut libero. Quisque dictum ante ac lectus iaculis, ac aliquet libero commodo</a></h4>
                <div class="post-prw-links">
    ...
    <div class="holder holder-subscribe-full mt-0" style="background-color: transparent;">
      <div class="container">
        <div class="row">
          <div class="col-auto">
            <div class="subscribe-form-title-lg">Get <span class="custom-color">20%</span> off</div>
            <div class="subscribe-form-title-sm">Subscribe and receive!</div>
          </div>
          <div class="col">
          ...
          <div class="col-lg-6 col-xl-4 last-mobile">
            <div class="footer-block">
              <div class="footer-logo">
                <a href="index.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/skins/games/logo-games.png 1x, images/skins/games/logo-games2x.png 2x" alt="Logo"></a>
              </div>
              <ul>
