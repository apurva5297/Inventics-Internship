                    ...
                    <div class="panel-group panel-group--style1" id="checkoutAccordion">
                        <div class="panel">
                            <div class="panel-heading active">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#step1">01. Shipping Address</a>
                            ...
                            <div id="step1" data-parent="#checkoutAccordion" class="panel-collapse collapse show">
                                <div class="panel-body">
                                    <div class="panel-body-inside">
                                        <p><a href="Route{{('AccountCreate')}}">Login</a> or <a href="Route{{('AccountCreate')}}">Register</a> for faster payment.</p>
                                        <div class="row mt-2">
                                            <div class="col-sm-9">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#step2">02. Billing Address</a>
                                    <span class="toggle-arrow"><span></span><span></span></span>
                                </h4>
                            </div>
