            ...
            <div class="row vert-margin justify-content-md-center">
                <div class="col-md-9">
                    ...
                    <div class="testimonials-carousel-wrap">
                        <div class="circle_decor_wrap">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 150 150" style="enable-background:new 0 0 150 150; width: 100%; transform: translate(-81%, -69%) rotate(-50deg); opacity: .5" xml:space="preserve"
