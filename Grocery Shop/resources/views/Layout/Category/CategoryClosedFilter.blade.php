                                ...
                                <ul class="category-list">
                                    <li class="active"><a href="Route{{('Category')}}" title="Casual" class="open">Casual&nbsp;<span>(30)</span></a>
                                        ...
                                        <ul class="category-list category-list">
                                            <li><a href="Route{{('Category')}}" title="Men">Men&nbsp;<span>(10)</span></a></li>
                                            <li><a href="Route{{('Category')}}" title="Women">Women&nbsp;<span>(10)</span></a></li>
                                            <li><a href="Route{{('Category')}}" title="Accessories">Accessories&nbsp;<span>(10)</span></a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="{{Route('Food')}}" title="FoodMarket" class="open">FoodMarket</a></li>
