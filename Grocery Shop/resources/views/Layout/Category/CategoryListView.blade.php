                        ...
                        <div class="sidebar-block filter-group-block open">
                            ...
                            <div class="sidebar-block_content">
                                <ul class="category-list">
                                    ...
                                    <li><a href="Route{{('Category')}}" title="Cosmetics" class="open">Cosmetics&nbsp;<span>(16)</span></a></li>
                                    <li><a href="Route{{('Category')}}" title="Fishing" class="open">Fishing&nbsp;<span>(20)</span></a></li>
                                    <li><a href="Route{{('Category')}}" title="Electronics" class="open">Electronics&nbsp;<span>(15)</span></a></li>
                                    <li><a href="Route{{('Category')}}" title="Games" class="open">Games&nbsp;<span>(14)</span></a></li>
                                </ul>
                            </div>
                        </div>
