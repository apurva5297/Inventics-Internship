...
@section('content')
    ...
    <div class="holder">
        <div class="container">
            ...
            <div class="text-center mt-1"><button class="btn btn--grey"><span>UPDATE CART</span><i class="icon-refresh"></i></button></div>
            <div class="mt-4 mt-md-6">
                <div class="row vert-margin-md cart-table-under justify-content-center">
                    <div class="col-md col-xl order-2">
                        <h2>Note for the seller</h2>
                        <textarea class="form-control form-control--sm textarea--height-200" placeholder="Text here"></textarea>
                    </div>
                    <div class="col-md col-xl order-1">
                    ...
                    <div class="col-md col-xl order-0 order-lg-last">
