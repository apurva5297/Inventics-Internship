<div class="col-md-10">
            ...
            <div class="tab-content">
                @include('Layout.Cart.CheckOut2.Steps.shippingaddress')
                @include('Layout.Cart.CheckOut2.Steps.billingaddress')
                @include('Layout.Cart.CheckOut2.Steps.deliverymethod')
                @include('Layout.Cart.CheckOut2.Steps.paymentmethod')
            </div>
          </div>
