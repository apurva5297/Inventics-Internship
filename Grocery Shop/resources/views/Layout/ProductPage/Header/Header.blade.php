        ...
        <div class="dropdn-content-block">
            ...
            @if(Route::has('login'))
                @auth
                    ...
                    {{--                    </li>--}}
                    {{--                    <li class="text-md-left">--}}
                    {{--                        <a href="{{route('wishlist')}}" ><i class="icon-wishlist"></i> <span>&emsp;My Wishlist</span></a>--}}
                    {{--                    </li>--}}
                    {{--                    <li class="text-md-left">--}}
                    {{--                        <a href="{{route('cart')}}" ><i class="icon-cart"></i> <span>&emsp;My Cart</span></a>--}}
                    {{--                    </li>--}}
                    {{--                    <li class="text-md-left"><a href="{{ route('checkout1') }}"><i class="icon-card"></i> <span>&emsp;Checkout</span></a></li>--}}
                    {{--                    <li class="text-md-left"><a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">{{ __('Logout') }}</a>--}}
