...
<div class="page-content">
    ...
    <div class="holder">
        <div class="container js-prd-gallery" id="prdGallery">
            <div class="row prd-block prd-block--prv-right prd-block--prv-double">
                <div class="col-md-8 col-lg-9 aside--sticky js-sticky-collision">
                ...
                <div class="col-md-10 col-lg-9 mt-1 mt-md-0">
                                ...
                                <div class="prd-block_actions prd-block_actions--wishlist">
                                    ...
                                    <div class="btn-wrap">
                                        <button class="btn btn--add-to-cart js-trigger-addtocart js-prd-addtocart"
                                                data-product='{"name":  "Leather Pegged Pants ",  "url ": "product.html",  "path ": "images/skins/fashion/product-page/product-01.jpg",  "aspect_ratio ": "0.78"}'>Add to cart</button>
                                    </div>
                                ...
                                <div id="collapse2" class="panel-collapse collapse show">
                                    <div class="panel-body">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-9"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/product-description-01.png" alt="" class="lazyload"></div>
                                        </div>
                                        <div class="mt-3"></div>
                                        <h4>List heading</h4>
                                        <div class="row">
                                        ...
                                        <div class="row mt-3 align-items-center">
                                            <div class="col-md-9"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/product-description-02.png" alt="" class="lazyload"></div>
                                            <div class="col-md-9">
                                                <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the
                                                    truth, the master-builder of human happiness. </p>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        <div id="productReviews">
                                            <div class="row mb-2 align-items-center">
                                                ...
                                                <div class="col-sm-auto ml-auto"><a href="#" class="review-write-link"><i class="icon-pencil"></i>Write review</a></div>
                                            </div>
                                            <div class="review-item">
                                                ...
                                                <div class="review-item_content">
                                                    ...
                                                    <p>I recently bought this ball and this is the first ball that I actually buy based on quality and material, I always been playing my friend ball and one of them recommended me this, read some review online and decided to
                                                        buy it, the ball feel sticky at first but quality is nice and the hand wrote letter was awesome because it shows how much season creator actually care about their customers.</p>
                                                </div>
                                            </div>
                                            <div class="review-item">
                                                <div class="review-item_rating">
    ...
    <div class="holder prd-block_links-wrap-bg d-none d-md-block">
        <div class="prd-block_links-wrap prd-block_info_item container mt-2 mt-md-5 py-1">
            ...
            <div class="prd-block_link"><span>Use promocode FOXIC to get 15% discount!</span></div>
