<div class="col-lg aside">
    <div class="prd-grid-wrap">
        <!-- Products Grid -->
        <!-- Products Grid -->
        <div class="prd-listview product-listing data-to-show-3 data-to-show-md-3 data-to-show-sm-2 js-category-grid" id="my_searched_items_container" data-grid-tab-content>
                ...
                <div class="circle-loader" id="load_more_box">
                    <a href="#" id="custom_load_moree" data-total="30" data-loaded="12" data-load="6" class="lazyload js-circle-loader">
                        <svg id="svg_d" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle class="js-circle-bar" cx="50%" cy="50%" r="63" fill="transparent"></circle> </svg>
