...
class CheckoutController extends Controller
{
    public function index($cart_id)
    {
        ...
        return view('Layout.Cart.CheckOut2.index',compact('addresses','countries','cart','cart_data','shipping_data','current_currency'));
    }
    ...
    public function placeOrder(Request $request)
    {
        ...
        $create_order=false;
        $new_order_number="#".$this->isAuthenticated("id").$cart->id;
