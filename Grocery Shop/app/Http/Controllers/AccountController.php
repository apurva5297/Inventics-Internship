...
class AccountController extends Controller
{
    ...
    public function save_address(Request $request)
    {
        ...
        if ($request->has('primary_address')) {
...
//        dd("hello");
    ...
    public function orderList($order_id)
    {
        ...
        // dd($order_items);
        return view('Layout.Cart.OrderList.index', compact('order_items', 'orders'));
    }
...
public function index1()
{
    ...
    // dd($categories);
    return view('Layout.Account.AccountCreate',compact('categories','sub_categories','cat_product','minicartItems'));
}
}
