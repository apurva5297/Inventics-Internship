...
<ul class="account-sidebar-nav">
   ...
   <!--  <li class="{{ $tab == 'returns' ? 'active' : '' }}">
        <a href="{{ route('account', 'returns') }}"><i class="fa fa-shopping-cart"></i> @lang('Return')</a>
    </li> -->
    ...
    <li class="{{ $tab == 'returns' ? 'active' : '' }}">
        <a href="{{ route('account', 'returns') }}"><i class="fa fa-rocket"></i> Return</a>
    </li>
