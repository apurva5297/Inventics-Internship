...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- animation -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/animate.css') }}" />
        <!-- bootstrap -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/bootstrap.min.css')}}" />
        <!-- et line icon --> 
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/et-line-icons.css')}}" />
        <!-- font-awesome icon -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/font-awesome.min.css')}}" />
        <!-- themify icon -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/themify-icons.css')}}">
        <!-- swiper carousel -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/swiper.min.css')}}">
        <!-- justified gallery -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/justified-gallery.min.css')}}">
        <!-- magnific popup -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/magnific-popup.css')}}" />
        <!-- revolution slider -->
        <link rel="stylesheet" type="text/css" href="{{ theme_asset_url('landing/revolution/css/settings.css')}}" media="screen" />
        <link rel="stylesheet" type="text/css" href="{{ theme_asset_url('landing/revolution/css/layers.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ theme_asset_url('landing/revolution/css/navigation.css')}}">
        <!-- bootsnav -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/bootsnav.css')}}">
        <!-- style -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/style.css')}}" />
        <!-- responsive css -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing/css/responsive.css')}}" />
        <!--[if IE]>
    ...
    <body>
            ...
            <nav class="navbar navbar-default bootsnav navbar-top header-dark background-transparent navbar-expand-lg" style="background:rgba(255,255,255,1); color:#000">
                <div class="container nav-header-container">
                    ...
                    <div class="col-auto pl-lg-0">
                        <a href="{{url('/')}}" title="Pofo" class="logo"><img src="{{ theme_asset_url('img/z commerce_icon.png')}}" data-rjs="{{ theme_asset_url('img/z commerce_icon.png')}}" class="logo-dark default" alt="Pofo"><img src="{{ theme_asset_url('img/z commerce_icon.png')}}" data-rjs="{{ theme_asset_url('img/z commerce_icon.png')}}" alt="Pofo" class="logo-light"></a>
                    </div>
                    <!-- end logo -->
                            ...
                            <ul id="accordion" class="nav navbar-nav no-margin alt-font text-normal" data-in="fadeIn" data-out="fadeOut">
                                ...
                                <li class="dropdown simple-dropdown"><a href="#">Start</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Start Your Business <i class="fas fa-angle-right"></i></a>
                                        </li>
                                ...
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/')}}">Sell</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/')}}">Solution</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/')}}">Market</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/')}}">Manage</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                    ...
                    <div class="d-table-cell align-top padding-70px-top position-relative">
                        <div class="row">
                            <div class="col-lg-12 margin-70px-bottom">
                                <img src="{{ theme_asset_url('landing/images/slider/unislider1.jpeg')}}"/>
                            </div>
                            <div class="col-lg-12 margin-70px-bottom">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 widget border-right border-color-medium-dark-gray padding-45px-left md-padding-15px-left md-no-border-right md-margin-30px-bottom text-center text-md-left">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a class="text-small" href="page/{{$page->slug}}">{{ucfirst($page->title)}}</a></li>
                                @endforeach
                            </ul>
                        </div>
        ...
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/modernizr.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/bootstrap.bundle.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.easing.1.3.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/skrollr.min.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/smooth-scroll.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.appear.js')}}"></script>
        <!-- menu navigation -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/bootsnav.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.nav.js')}}"></script>
        <!-- animation -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/wow.min.js')}}"></script>
        <!-- page scroll -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/page-scroll.js')}}"></script>
        <!-- swiper carousel -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/swiper.min.js')}}"></script>
        <!-- counter -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.count-to.js')}}"></script>
        <!-- parallax -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.stellar.js')}}"></script>
        <!-- magnific popup -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.magnific-popup.min.js')}}"></script>
        <!-- portfolio with shorting tab -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/isotope.pkgd.min.js')}}"></script>
        <!-- images loaded -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/imagesloaded.pkgd.min.js')}}"></script>
        <!-- pull menu -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/classie.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/hamburger-menu.js')}}"></script>
        <!-- counter -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/counter.js')}}"></script>
        <!-- fit video -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.fitvids.js')}}"></script>

        <!-- skill bars -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/skill.bars.jquery.js')}}"></script> 
        <!-- justified gallery -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/justified-gallery.min.js')}}"></script>
        <!-- pie chart -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/jquery.easypiechart.min.js')}}"></script>
        <!-- retina -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/retina.min.js')}}"></script>
        <!-- revolution -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing/revolution/js/jquery.themepunch.revolution.min.js')}}"></script>
        
        <!-- setting -->
        <script type="text/javascript" src="{{ theme_asset_url('landing/js/main.js')}}"></script>
    </body>
</html>