<div class="holder fullwidth mt-0 full-nopad">
  <div class="container">
    <div class="bnslider-wrapper">
      <div class="bnslider keep-scale" data-start-width='1920' data-start-height='864' data-start-mwidth='1200' data-start-mheight='1100' id="bnslider-1586195671359" data-autoplay="true" data-speed="15000" style="background-color: #333" >
        <div class="bnslider-slide" data-autoplay="true" data-video-type="video">
          <div class="bnslider-image-mobile lazyload fade-up-fast" style=" background-image:url( {{ get_cover_img_src($shop, 'shop') }} )" data-sizes="auto"></div>
          <div class="bnslider-image lazyload fade-up-fast" style=" background-image:url( {{ get_cover_img_src($shop, 'shop') }} )" data-sizes="auto"></div>
            ...
            <div class="bnslider-text-content txt-middle txt-right txt-middle-m txt-right-m">
              <div class="bnslider-text-content-flex ">
                <div class="bnslider-vert w-s-40 w-ms-50 p-0">
                  <div class="bnslider-text order-1 mt-0 bnslider-text--lg text-left heading-font" data-animation="fadeInUp" data-animation-delay="800" data-fontcolor="#000000" data-bgcolor="" data-fontweight="700" data-fontline="1.15" data-otherstyle="">{{ $shop->name }}</div>
