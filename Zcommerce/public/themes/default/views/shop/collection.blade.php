      ...
      <a target="_blank" class="bnr-wrap bnr-">
        <div class="bnr custom-caption image-hover-scale bnr--middle bnr--right bnr--fullwidth">
          ...
          <div class="bnr-img d-sm-none image-container" style="padding-bottom: 74.3139407244786%">
            <img src="{{ theme_asset_url('data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/banner-fashion2-full-m.png')}}" class="lazyload fade-up" alt="">
          </div>
