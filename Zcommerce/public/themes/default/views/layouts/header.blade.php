              ...
              <div class="hdr-inline-link">
                ...
                <div class="dropdn_language">
                  <div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
                    ...
                    <div class="dropdn-content">
                      <ul>
                        <li class="active"><a href="#"><img src="{{ theme_asset_url('images/flags/en.png')}}" alt="">English</a></li>
                        <li><a href="#"><img src="{{ theme_asset_url('images/flags/de.png')}}" alt="">German</a></li>
                        <li><a href="#"><img src="{{ theme_asset_url('images/flags/fr.png')}}" alt="">French</a></li>
                        <li><a href="#"><img src="{{ theme_asset_url('images/flags/sp.png')}}" alt="">Spanish</a></li>
                        </ul>
                        </div>
                        </div>
                  <!-- /Header Language -->
                ...
                <li class="mmenu-item--simple"><a href="#" class="active">Home</a>
                  <div class="mmenu-submenu d-flex">
                    <ul class="submenu-list mt-0">
                      <li><a href="index.html">Fashion (Default) Skin</a><span class="submenu-link-image"><img src="{{ theme_asset_url('images/screen/screen01.png')}}" alt=""></span></li>
                      ...
                      <div class="container">
                        <div class="mmenu-left width-25">
                          <div class="mmenu-bnr-wrap">
                            <a href="#" class="image-hover-scale"><img src="{{ theme_asset_url('data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/menu/mmenu-bnr-01.png')}}" class="lazyload fade-up" alt=""></a>
                          </div>
                    ...
                    <div class="mmenu-submenu-inside">
                      <div class="container">
                        <div class="mmenu-right width-25">
                          <div class="mmenu-bnr-wrap">
                            <a href="#" class="image-hover-scale"><img src="{{ theme_asset_url('data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/menu/mmenu-bnr-02.png')}}" class="lazyload fade-up" alt=""></a>
                          </div>
                          <h3 class="submenu-title"><a href="category.html">Pre-Collection<br>Spring-Summer 2021</a></h3>
                        </div>
                        <div class="mmenu-cols column-4">
