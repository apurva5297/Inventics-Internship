    ...
    <div class="container">
      <div class="row">
        <div class="col-auto sticky-addcart_image">
          <a href="product.html">
            <img src="{{ theme_asset_url('images/skins/fashion/products/product-01-1.jpg')}}" alt="" />
          </a>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-auto popup-addedtocart_logo">
          <img src="{{ theme_asset_url('data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/logo-white-sm.png')}}" class="lazyload fade-up" alt="">
        </div>
