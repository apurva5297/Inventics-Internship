...
--}}
	...
	<div class="row">
  	<!-- <div class="col-sm-6 hidden-xs nopadding-right">
      	<div class="product-info-availability space10">@lang('theme.availability'):
      		<span>{{ $item->stock_quantity > 0 ? trans('theme.in_stock') : trans('theme.out_of_stock') }}</span>
      	</div>
  	</div> -->
  	<div class="col-sm-6 hidden-xs nopadding-left">
	...
	<a href="{{ route('wishlist.add', $item->product) }}" class="btn btn-link hidden-xs">
