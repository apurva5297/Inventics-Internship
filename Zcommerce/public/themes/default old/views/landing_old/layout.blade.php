...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- animation -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/animate.css') }}" />
        <!-- bootstrap -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/bootstrap.min.css')}}" />
        <!-- et line icon --> 
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/et-line-icons.css')}}" />
        <!-- font-awesome icon -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/font-awesome.min.css')}}" />
        <!-- themify icon -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/themify-icons.css')}}">
        <!-- swiper carousel -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/swiper.min.css')}}">
        <!-- justified gallery -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/justified-gallery.min.css')}}">
        <!-- magnific popup -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/magnific-popup.css')}}" />
        <!-- revolution slider -->
        <link rel="stylesheet" type="text/css" href="{{ theme_asset_url('landing_old/revolution/css/settings.css')}}" media="screen" />
        <link rel="stylesheet" type="text/css" href="{{ theme_asset_url('landing_old/revolution/css/layers.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ theme_asset_url('landing_old/revolution/css/navigation.css')}}">
        <!-- bootsnav -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/bootsnav.css')}}">
        <!-- style -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/style.css')}}" />
        <!-- responsive css -->
        <link rel="stylesheet" href="{{ theme_asset_url('landing_old/css/responsive.css')}}" />
        <!--[if IE]>
    ...
    <body>
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-default bootsnav navbar-top header-dark background-transparent navbar-expand-lg" style="background:rgba(255,255,255,1); color:#000">
                <div class="container nav-header-container">
                    <!-- start logo -->
                    <div class="col-auto pl-lg-0">
                        <a href="{{url('/')}}" title="Pofo" class="logo"><img src="{{ theme_asset_url('img/z commerce_logo 2.png')}}" data-rjs="{{ theme_asset_url('img/z commerce_logo 2.png')}}" class="logo-dark default" alt="Pofo"><img src="{{ theme_asset_url('img/z commerce_logo 2.png')}}" data-rjs="{{ theme_asset_url('img/z commerce_logo 2.png')}}" alt="Pofo" class="logo-light"></a>
                    </div>
                    <!-- end logo -->
                    <div class="col accordion-menu pr-0 pr-md-3">
                        ...
                        <div class="navbar-collapse collapse justify-content-end" id="navbar-collapse-toggle-1">
                            <ul id="accordion" class="nav navbar-nav no-margin alt-font text-normal" data-in="fadeIn" data-out="fadeOut">
                                <!-- start menu item -->
                                <li class="dropdown simple-dropdown"><a href="#">Start</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    <!-- start sub menu -->
                                    <ul class="dropdown-menu" role="menu">
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/sell-your-business')}}">Start Your Business <i class="fas fa-angle-right"></i></a>
                                        </li>
                                        <!-- <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Branding <i class="fas fa-angle-right"></i></a>
                                            
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Online <i class="fas fa-angle-right"></i></a>
                                            
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Start Setup <i class="fas fa-angle-right"></i></a>
                                ...
                                <!-- <li class="dropdown megamenu-fw">
                                    <a href="{{url('/sell')}}">Sell</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li> -->
                                <li class="dropdown simple-dropdown"><a href="#">Solution</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    <!-- start sub menu -->
                                    <ul class="dropdown-menu" role="menu">
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/multichannel-solution')}}">Multichannel solutions <i class="fas fa-angle-right"></i></a>
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/warehouse-management')}}">Warehouse management <i class="fas fa-angle-right"></i></a>
                                            
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/ominchannel-solution')}}">Omnichannel solution <i class="fas fa-angle-right"></i></a>
                                            
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/drop-shipment-solution')}}">Drop shipment solution <i class="fas fa-angle-right"></i></a>
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/erp-integration')}}">ERP integration <i class="fas fa-angle-right"></i></a>
                                        </li>
                                    </ul>
                                </li>
                                
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/market')}}">Market</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/manage')}}">Manage</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/price-list')}}">Pricing</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown simple-dropdown"><a href="#">Learn</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    <!-- start sub menu -->
                                    <ul class="dropdown-menu" role="menu">
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/all-blog')}}">Blog <i class="fas fa-angle-right"></i></a>
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/faqs')}}">Faqs <i class="fas fa-angle-right"></i></a>
                                            
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/login')}}">Help Center <i class="fas fa-angle-right"></i></a>
                                ...
                                <li class="dropdown megamenu-fw">
                                    <a href="{{url('/contact-us')}}">Contact Us</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    
                                </li>
                                <li class="dropdown simple-dropdown"><a href="#">Account</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                                    <!-- start sub menu -->
                                    <ul class="dropdown-menu" role="menu">
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/register')}}">Register <i class="fas fa-angle-right"></i></a>
                                        </li>
                                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="{{url('/login')}}">Login <i class="fas fa-angle-right"></i></a>
                    ...
                    <div class="d-table-cell align-top padding-70px-top position-relative">
                        <div class="row">
                            <div class="col-lg-12 margin-70px-bottom">
                                <img src="{{ theme_asset_url('landing_old/images/slider/unislider1.jpeg')}}"/>
                            </div>
                            <div class="col-lg-12 margin-70px-bottom">
                                <img src="images/sidebar-image1.png"/>
                            </div>
                            <div class="col-lg-12">
                                <h5 class="alt-font text-extra-dark-gray"><span class="d-block font-weight-300 text-dark-gray">The world's most</span><strong>powerful Platform.</strong></h5>
                            </div>
                            <div class="col-lg-12">
                                <a href="{{url('register')}}" class="btn btn-deep-pink btn-small text-extra-small border-radius-4"><i class="fas fa-play-circle icon-very-small margin-5px-right no-margin-left" aria-hidden="true"></i>Register Now</a>
                            </div>
                            <div class="col-md-12 margin-100px-top text-center">
                                <div class="icon-social-medium margin-three-bottom">
                                    <a href="" target="_blank" class="text-extra-dark-gray text-deep-pink-hover margin-one-lr"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                                    <a href="" target="_blank" class="text-extra-dark-gray text-deep-pink-hover margin-one-lr"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                                    <a href="" target="_blank" class="text-extra-dark-gray text-deep-pink-hover margin-one-lr"><i class="fab fa-dribbble" aria-hidden="true"></i></a>
                                    <a href="" target="_blank" class="text-extra-dark-gray text-deep-pink-hover margin-one-lr"><i class="fab fa-google-plus-g" aria-hidden="true"></i></a>
                                    <a href="" target="_blank" class="text-extra-dark-gray text-deep-pink-hover margin-one-lr"><i class="fab fa-tumblr" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="footer-standard-dark bg-extra-dark-gray"> 
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 widget border-right border-color-medium-dark-gray md-no-border-right md-margin-30px-bottom sm-text-center">
                            ...
                            <!-- end logo -->
                            <p class="text-small width-95 sm-width-100">Zcommerce is a team of young minds which brings fresh innovative ideas to implement into your business and make them grow. Zcommerce is the only place to start and expand your business.</p>
                            <!-- start social media -->
                        ...
                        <div class="col-lg-3 col-md-6 widget border-right border-color-medium-dark-gray padding-45px-left md-padding-15px-left md-no-border-right md-margin-30px-bottom text-center text-md-left">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a class="text-small" href="{{url($page->slug)}}">{{ucfirst($page->title)}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 widget border-right border-color-medium-dark-gray padding-45px-left md-padding-15px-left md-no-border-right md-margin-30px-bottom text-center text-md-left">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="page/{{$page->slug}}">{{ucfirst($page->title)}}</a></li>
                                @endforeach
                            </ul>
                        </div>
            ...
            <div class="bg-dark-footer padding-50px-tb text-center sm-padding-30px-tb">
                <div class="container">
                    <div class="row">
                        <!-- start copyright -->
                        <div class="col-md-6 text-md-left text-small text-center">&copy; {{ date('Y') }} {{ get_platform_title() }} </div>
                        <div class="col-md-6 text-md-right text-small text-center">
                            @foreach($copyright_page as $page)
                            <a href="javascript:void(0);" class="text-dark-gray">{{ucfirst($page->title)}}</a>
                            &nbsp;&nbsp;|
                            @endforeach
                        </div>
                        <!-- end copyright -->
        ...
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/modernizr.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/bootstrap.bundle.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.easing.1.3.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/skrollr.min.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/smooth-scroll.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.appear.js')}}"></script>
        <!-- menu navigation -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/bootsnav.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.nav.js')}}"></script>
        <!-- animation -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/wow.min.js')}}"></script>
        <!-- page scroll -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/page-scroll.js')}}"></script>
        <!-- swiper carousel -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/swiper.min.js')}}"></script>
        <!-- counter -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.count-to.js')}}"></script>
        <!-- parallax -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.stellar.js')}}"></script>
        <!-- magnific popup -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.magnific-popup.min.js')}}"></script>
        <!-- portfolio with shorting tab -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/isotope.pkgd.min.js')}}"></script>
        <!-- images loaded -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/imagesloaded.pkgd.min.js')}}"></script>
        <!-- pull menu -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/classie.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/hamburger-menu.js')}}"></script>
        <!-- counter -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/counter.js')}}"></script>
        <!-- fit video -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.fitvids.js')}}"></script>

        <!-- skill bars -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/skill.bars.jquery.js')}}"></script> 
        <!-- justified gallery -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/justified-gallery.min.js')}}"></script>
        <!-- pie chart -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/jquery.easypiechart.min.js')}}"></script>
        <!-- retina -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/retina.min.js')}}"></script>
        <!-- revolution -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/revolution/js/jquery.themepunch.revolution.min.js')}}"></script>
        
        <!-- setting -->
        <script type="text/javascript" src="{{ theme_asset_url('landing_old/js/main.js')}}"></script>
    </body>
</html>