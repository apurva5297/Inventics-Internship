              ...
              <td width="20%" class="order-amount">
                ...
                <div class="btn-group" role="group">
                  ...
                  @if(optional($order->status)->name == 'Delivered')
                   <a class="btn btn-xs btn-default flat" style="margin-top: 4px;" href="{{ route('order.return', $order) }}">@lang('Return Request')</a>
                   @endif
                </div>
            ...
            <tr class="order-body">
              ...
              @if($loop->first)
                <td rowspan="{{ $loop->count }}" class="order-actions">
                  ...
                  <a href="{{ route('order.return', $order) }}" class="btn btn-link btn-block">Return</a>
                </td>
              @endif
            </tr> <!-- /.order-body -->
          @endforeach
