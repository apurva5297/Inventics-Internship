		  	...
		  	<div class="col-md-7 col-sm-6">
		  		<div class="row">
				                  	...
				                  	<div class="row">
									  	...
									  	<div class="col-sm-9 col-xs-8 nopadding">
							              	<div class="product-qty-wrapper">
								                ...
								                @endif
							                  	<span class="available-qty-count">
							                  		<span>{{ $item->stock_quantity > 0 ? $item->stock_quantity.' item in stock' : trans('theme.out_of_stock') }}</span>
							                  	</span>
							              	</div>
						              	</div><!-- /.col-sm-9 .col-xs-6 -->
				                  	</div><!-- /.row -->
				  	...
				  	<div class="col-md-5 col-sm-6 nopadding-right">
				        ...
				        --}}
				        <!-- /.seller-info -->
				       @if($item->shop->active != 1)
				       	<a href="" class="btn btn-primary btn-lg btn-block flat space10 sc-add-to-cart">
			          		<i class="fa fa-shopping-bag"></i> @lang('Seller Not Available')
			          	</a>
				       @else
				       @if($item->stock_quantity > 0)
					        @if($item->set_desc == 'One Piece')
							    <a href="{{ route('cart.simpel_addItem', $item->slug) }}" class="btn btn-primary btn-lg btn-block flat space10 sc-add-to-cart">
          		...
          		<div role="tabpanel">
	              	<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active">
							<a href="#desc_tab" aria-controls="desc_tab" role="tab" data-toggle="tab" aria-expanded="true">@lang('Description')</a>
						</li>
						{{--
						...
						--}}
						<li role="presentation">
							<a href="#reviews_tab" aria-controls="reviews_tab" role="tab" data-toggle="tab" aria-expanded="false">@lang('Reviews')</a>
						</li>
					</ul><!-- /.nav-tab -->
