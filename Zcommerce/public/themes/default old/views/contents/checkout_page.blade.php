      ...
      <div class="row space30">
        ...
        <div class="col-md-5">
          ...
          @else
              ...
              <div class="checkbox">
                <label>
                  <input type="checkbox" name="create-account" id="create-account-checkbox" checked="checked"style="display: none;">
                  {{--
              ...
              <div id="create-account" class="space30">
                <div class="row">
              ...
              @foreach($shop->paymentMethods as $payment_provider)
                @php
                  switch ($payment_provider->code) {
                    ...
                    case 'paytm':
                      $has_config = $shop->paytm ? TRUE : FALSE;
                      $info = trans('You will be redirected to paytm');
                      break;
