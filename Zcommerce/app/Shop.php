...
class Shop extends Model
{
   ...
   /**
    ...
    {
        return $this->hasMany(ReturnOrders::class);
    }
   ...
   /**
    ...
    {
        return $this->hasOne(ConfigPaytm::class, 'shop_id')->withDefault();
    }
    ...
    public function FlipkartPreviousOrder()
    {
        return $this->hasMany(FlipkartPreviousOrder::class);
    }

    public function FlipkartPaymentStorageRecall()
    {
        return $this->hasMany(FlipkartPaymentStorageRecall::class);
    }
