...
class Inventory extends Model
{
    ...
    public function InventoryFsnMapping()
    {
        return $this->hasMany(InventoryFsnMapping::class);
    }
    /**
    ...
    {
        return $this->belongsToMany(ReturnOrders::class, 'return_order_items_inventory_id_foreign');
    }
    ...
    {
        return $this->belongsTo(MeasuringUnit::class,'measuring_unit');
    }
