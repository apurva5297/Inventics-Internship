...
class EloquentOrder extends EloquentRepository implements BaseRepository, OrderRepository
{
    ...
    public function shopOrder(Request $request)
    {
        ...
        $order_status=$request->order_status ? $request->order_status : null;
    ...
    public function shopOrderDetail(Request $request)
    {
        ...
        return Order::where(['shop_id'=>$shop_id,'id'=>$order_id])->first();
    }
    ...
    public function orderStatusUpdate(Request $request)
    {
        ...
        if($request->shop_id == $order->shop_id)
        {
            Order::where('id',$order_id)->update(['order_status_id'=>$status]);
            return "Order updated successfully";
        }
        else
            return "You do not have permission to fullfill order";
    }
}