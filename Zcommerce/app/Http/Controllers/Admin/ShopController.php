...
class ShopController extends Controller
{
    ...
    {
        $seller_category_data = array(
            'shop_id' => Auth::user()->merchantId(),
            'master_category_id' => json_encode($request->master_category),
            'category_group_id' => json_encode($request->category_group),
            'category_sub_group_id' => json_encode($request->sub_category),
        );
        ShopCategory::updateOrCreate(['shop_id'=>Auth::user()->merchantId()],$seller_category_data);
        $shop = $this->shop->update($request, Auth::user()->merchantId());
