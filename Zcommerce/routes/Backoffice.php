...
Route::group(['middleware' => ['auth'], 'namespace' => 'Admin', 'as' => 'admin.', 'prefix' => 'admin'], function()
{
	...
	Route::get('ajax-get-category_group/{master_cate_id}','AjaxController@ajaxGetCategoryGroup');

	Route::post('/ajax-get-sub_category','AjaxController@ajaxGetSubCategory');
	Route::post('create_shop_category', 'ShopController@createShopCategory');
	...
	Route::middleware(['subscribed'])->group(function ()
	{
		...
		Route::get('check-flow', 'DashboardController@checkFlow')->name('admin.check-flow');
		...
		{
			include('admin/CategoryMaster.php');
		...
		// mapping Routes for Admin
		Route::group(['as' => 'catpro.', 'prefix' => 'catpro'], function()
		{
			include('admin/Mapping.php');
		});
