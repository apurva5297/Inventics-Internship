<?php
	...
	Route::post('product_consolidate_data', 'ProductController@fetchData');

	Route::get('product/fsn/mapping/page/{id}', 'ProductUploadController@MappingFsnPage')->name('product.fsn.mapping.page');

    Route::post('product/fsn/mapping/upload', 'ProductUploadController@MappingFsnUpload')->name('product.fsn.mapping.upload');