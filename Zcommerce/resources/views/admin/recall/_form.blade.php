      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6 nopadding-right">
            <div class="form-group">
              {!! Form::label('Bar Code', 'Bar code'.'*', ['class' => 'with-help']) !!}
              <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ 'Bar code no' }}"></i>
              {!! Form::text('barcode', null, ['class' => 'form-control', 'placeholder' => 'Enter Bar Code', 'required']) !!}
              <div class="help-block with-errors"></div>
            </div>
          </div>
         <div class="col-md-6 nopadding-right">
            <div class="form-group">
              {!! Form::label('QR Code', 'QR Code'.'*', ['class' => 'with-help']) !!}
              <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ 'Enter QR Code' }}"></i>
              {!! Form::text('qrcode', null, ['class' => 'form-control', 'placeholder' =>'Enter QR Code', 'required']) !!}
              <div class="help-block with-errors"></div>
            </div>
          </div>
        </div>
        ...
        <fieldset>
          ...
          @if($requires_shipping)
            <div class="row">
              ...
              <div class="col-md-4 nopadding-left">
                <div class="form-group">
                  {!! Form::label('sample_product_available', trans('Sample Product Available'), ['class' => 'with-help']) !!}
                  {!! Form::select('is_sample', ['no' => trans('No'),'yes' => trans('Yes')], isset($inventory) ? null : 'no', ['class' => 'form-control select2-normal', 'placeholder' => trans('app.placeholder.select')]) !!}
                </div>
              </div>
            </div>
          @endif
          ...
          <div class="row">
            <div class="col-md-6 nopadding-right">
              <div class="form-group">
                {!! Form::label('sale_price', trans('Price Per SET').'*', ['class' => 'with-help']) !!}
                ...
                <div class="input-group">
                  ...
                  <input name="sale_price" value="{{ isset($inventory) ? $inventory->sale_price : Null }}" type="number" min="{{ $product->min_price }}" {{ $product->max_price ? ' max="'. $product->max_price .'"' : '' }} step="any" placeholder="{{ trans('Price Per Piece') }}" class="form-control" required="required">
                </div>
                <div class="help-block with-errors"></div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 nopadding-left">
                <div class="form-group">
                  {!! Form::label('set_size', trans('SET SIZE'), ['class' => 'with-help']) !!}
                  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.min_order_quantity') }}"></i>
                  {!! Form::number('set_size', isset($inventory) ? null : 1, ['min' => 1, 'class' => 'form-control', 'placeholder' => trans('Set Size')]) !!}
                </div>
              </div>
          </div>
                <div class="form-group">
                  {!! Form::label('set_desc', trans('SET DESCRIPTION'), ['class' => 'with-help']) !!}
                  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('This is seller specific description of the Set. Customer will see this') }}"></i>
                  {!! Form::text('set_desc', isset($inventory) ? null : 1, ['class' =>'form-control', 'placeholder' => trans('Set Description')]) !!}
                </div>
