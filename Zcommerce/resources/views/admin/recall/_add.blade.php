<div class="box collapsed-box">
	<div class="box-header with-bcart">
		...
		<div class="box-tools pull-right">
			<a href="{{ route('admin.stock.inventory.recall_bulk') }}" class="ajax-modal-btn btn btn-default btn-flat">{{ trans('app.bulk_import') }}</a>
			<a href="{{ route('admin.stock.inventory.recall_csv') }}" class="btn btn-default btn-flat">Download CSV</a>
