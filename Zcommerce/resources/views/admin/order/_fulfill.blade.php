<div class="modal-dialog modal-sm">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              {!! Form::label('image', trans('Image'), ['class' => 'with-help']) !!}
              <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('tracking Image File') }}"></i>
              <input type="file" name="tracking_image" />
              <div>
                   @if($order->tracking_file)
                   <a href="{{ url('images/tracking_image', $order->tracking_file) }}" target="_blank" class="grid-item" style="float: right;">Tracking File</a>
                    @endif
              </div>
