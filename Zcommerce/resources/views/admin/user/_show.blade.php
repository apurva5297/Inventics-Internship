			                ...
			                <tr>
			               	...
			               	@if($user->pan_no)
				                <tr>
				                	<th>{{ trans('PAN No') }}: </th>
				                	<td>{{ $user->pan_no }}
				                		<a href="{{ url('images/agent', $user->pan_img) }}" target="_blank" class="grid-item" style="float: right;">PAN No Document</a>
				                	</td>

				                </tr>
				            @endif
				            @if($user->cancelled_cheque_no)
				                <tr>
				                	<th>{{ trans('Cancelled Cheque No') }}: </th>
				                	<td>{{ $user->cancelled_cheque_no }}
				                		<a href="{{ url('images/agent', $user->cancelled_img) }}" target="_blank" class="grid-item" style="float: right;">Cancelled Cheque Document</a>
				                	</td>
