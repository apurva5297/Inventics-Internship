...
<div class="row">
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      {!! Form::label('cancelled_cheque', trans('Cancelled Cheque')) !!}
      {!! Form::text('cancelled_cheque_no', null, ['class' => 'form-control', 'placeholder' => trans('Enter Cancelled Cheque No')]) !!}
    </div>
  </div>
</div>
<div class="row">
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      <input type="file" name="cancelled_cheque_img"  />
    </div>
  </div>
</div>
<div class="form-group">
