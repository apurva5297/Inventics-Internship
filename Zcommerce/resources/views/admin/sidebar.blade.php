...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
      <ul class="sidebar-menu">
              ...
              @if(Gate::allows('index', \App\Category::class) || Gate::allows('index', \App\CategoryGroup::class) || Gate::allows('index', \App\CategorySubGroup::class))
                <li class="{{ Request::is('admin/catalog/category*') ? 'active' : '' }}">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="{{ Request::is('admin/catalog/mastercategory*') ? 'active' : '' }}">
                        <a href="{{ url('admin/catalog/master-category') }}">
                          <i class="fa fa-angle-right"></i>{{ trans('Master Category') }}
                        </a>
                      </li>
        ...
        <li class=" {{ Request::is('admin/catpro/mapping*') ? 'active' : '' }}">
           <a href="{{ url('admin/catpro/mapping') }}">
              <i class="fa fa-refresh"></i> {{ trans('bulk mapping') }}
          </a>
        </li>
        ...
        @if(Gate::allows('index', \App\Inventory::class) || Gate::allows('index', \App\Warehouse::class) || Gate::allows('index', \App\Supplier::class))
          <li class="treeview {{ Request::is('admin/stock*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              ...
              @endcan
               @can('index', \App\Inventory::class)
                <li class=" {{ Request::is('admin/stock/inward*') ? 'active' : '' }}">
                  <a href="{{ url('admin/stock/inward') }}">
                    <i class="fa fa-angle-double-right"></i>InWard
                  </a>
                </li>
              @endcan
              @can('index', \App\Inventory::class)
                <li class=" {{ Request::is('admin/stock/recall*') ? 'active' : '' }}">
                  <a href="{{ url('admin/stock/recall') }}">
                    <i class="fa fa-angle-double-right"></i> Recall
                  </a>
                </li>
              @endcan
              ...
              @endcan
                @can('index', \App\Inventory::class)
                <li class=" {{ Request::is('admin/stock/pricelist*') ? 'active' : '' }}">
                  <a href="{{ url('admin/stock/pricelist') }}">
                    <i class="fa fa-angle-double-right"></i> Price List
                  </a>
                </li>
              @endcan
              <li class=" {{ Request::is('admin/stock/marketplace*')? 'active' : '' }}">
                  <a href="{{ url('admin/stock/marketplace') }}">
                    <i class="fa fa-angle-double-right"></i>Market Place
                  </a>
                </li>
              <li class=" {{ Request::is('admin/marketplace*')? 'active' : '' }}">
                <a href="{{ url('admin/stock/marketplace-listing') }}">
                  <i class="fa fa-angle-double-right"></i> MarketPlace Listing
                </a>
              </li>
            </ul>
          </li>
        ...
        @if(Gate::allows('index', \App\User::class) || Gate::allows('index', \App\Customer::class))
          <li class="treeview {{ Request::is('admin/admin*') || Request::is('address/addresses/customer*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              ...
              @endcan
               @can('index', \App\Customer::class)
                <li class=" {{ Request::is('admin/admin/marketplace*')? 'active' : '' }}">
                  <a href="{{ url('admin/admin/marketplace') }}">
                    <i class="fa fa-angle-double-right"></i>Market Place
                  </a>
                </li>
              @endcan
              <!-- <li class="">
               <a href="{{ url('admin/admin/marketplace-module-mapping') }}">
                  <i class="fa fa-refresh"></i> {{ trans('Marketplace Mapping') }}
              </a>
            </li> -->
            </ul>
          </li>
          ...
          <li class="treeview {{ Request::is('admin/support*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              @if(Auth::user()->isAdmin())
                <li class=" {{ Request::is('admin/support/demo-request*') ? 'active' : '' }}">
                  <a href="{{ url('admin/support/demo-request') }}">
                    <i class="fa fa-angle-double-right"></i> {{ trans('Demo Request') }}
                  </a>
                </li>
              @endif
