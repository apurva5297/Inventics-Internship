@php
$platforms = [1=>'Zshop',2=>'Zmarketplace',3=>'Zcommerce'];
@endphp
<div class="form-group">
  {!! Form::label('platform_id', trans('platform id').'*') !!}
  {!! Form::select('platform_id', $platforms , null, ['class' => 'form-control select2', 'placeholder' => trans('Platforms'), 'required']) !!}
