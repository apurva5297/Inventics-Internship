...
@section('content')
	<div class="box">
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\Product::class)
					<a href="{{ route('admin.catalog.product.fsn.mapping.page','Attribute?marketplace_id='.'1') }}" class="ajax-modal-btn btn btn-default btn-flat">{{ trans('csv import for mapping') }}</a>
		...
		<div class="box-body">
		    <table class="table table-hover" id="product_ajax_list">
		        <thead>
					<tr>
