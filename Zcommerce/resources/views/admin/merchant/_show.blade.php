				        ...
				        <table class="table">
			                ...
			                <tr>
				                ...
				                <tr>
				                	...
				                	<td>{{ $merchant->gstin }}
				                		<a href="{{ url('images/client', $merchant->gstin_img) }}" target="_blank" class="grid-item" style="float: right;">GSTIN Document</a>
				            ...
				            @endif
				             @if($merchant->pan_no)
				                <tr>
				                	<th>{{ trans('PAN No') }}: </th>
				                	<td>{{ $merchant->pan_no }}
				                		<a href="{{ url('images/client', $merchant->pan_img) }}" target="_blank" class="grid-item" style="float: right;">PAN No Document</a>
				                		
				                	</td>

				                </tr>
				            @endif
				             @if($merchant->comp_doc)
				                <tr>
				                	<th>{{ trans('Company Name') }}: </th>
				                	<td>{{ $merchant->comp_doc }}
				                		<a href="{{ url('images/client', $merchant->comp_img) }}" target="_blank" class="grid-item" style="float: right;">Company Document</a>
