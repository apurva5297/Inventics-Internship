...
<div class="row">
  <div class="col-md-4 nopadding-right">
    <div class="form-group">
      {!! Form::label('GSTIN No', trans('GSTIN No')) !!}
      {!! Form::text('gstin', null, ['class' => 'form-control', 'placeholder' => trans('Enter GSTIN No')]) !!}
    </div>

  </div>
  <div class="col-md-4 sm-padding">
    <div class="form-group">
      {!! Form::label('PAN No', trans('PAN No')) !!}
      {!! Form::text('pan_no', null, ['class' => 'form-control', 'placeholder' => trans('Enter Pan No')]) !!}
    </div>
  </div>
  <div class="col-md-4 nopadding-left">
    <div class="form-group">
      {!! Form::label('Company Name', trans('Company Name')) !!}
      {!! Form::text('comp_doc', null, ['class' => 'form-control', 'placeholder' => trans('Enter Company Neme')]) !!}
    </div>
  </div>
</div>
<div class="row">
  <div class="col-md-4 nopadding-right">
    <div class="form-group">
     <input type="file" name="gstin_img_doc"   />
    </div>
    
  </div>
  <div class="col-md-4 sm-padding">
    <div class="form-group">
      <input type="file" name="pan_doc_img"  />
    </div>
  </div>
  <div class="col-md-4 nopadding-left">
    <div class="form-group">
      <input type="file" name="comp_doc_img"  />
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-4 nopadding-right">
    <div class="form-group">
      ...
      {!! Form::text('bank_name', null, ['class' => 'form-control', 'placeholder' => trans('Enter Bank Name')]) !!}
    </div>

  </div>
  <div class="col-md-4 sm-padding">
    <div class="form-group">
      {!! Form::label('account_no', trans('Account Number')) !!}
      {!! Form::text('account_no', null, ['class' => 'form-control', 'placeholder' => trans('Enter Account No')]) !!}
    </div>
  </div>
  <div class="col-md-4 nopadding-left">
    <div class="form-group">
      {!! Form::label('ifsc_code', trans('IFSC Code')) !!}
      {!! Form::text('ifsc_code', null, ['class' => 'form-control', 'placeholder' => trans('Enter IFSC Code')]) !!}
    </div>
  </div>
</div>
@if(isset($merchant))
