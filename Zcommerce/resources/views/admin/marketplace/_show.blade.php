				    ...
				    <div class="tab-pane active" id="basic_info_tab">
				        <table class="table">
			                ...
			                <tr>
			                	...
			                	<td><?php echo '₹'?>{{ $amount[0]->wallet_amnt }}</td>
			                </tr>
			                <tr>
			                <th>{{ trans('How Many % be Use') }}: </th>
			                	<td><?php echo $amount[0]->use.' % '?></td>
			                </tr>
				            ...
				            @endif
				             ...
				             @if($customer->gstin)
				                <tr>
				                	<th>{{ trans('GSTIN No') }}: </th>
				                	<td>{{ $customer->gstin }}
				                		<a href="{{ url('images/customer', $customer->gstin_img) }}" target="_blank" class="grid-item" style="float: right;">GSTIN Document</a>
				            ...
				            @if($customer->pan_no)
				                <tr>
				                	<th>{{ trans('PAN No') }}: </th>
				                	<td>{{ $customer->pan_no }}
				                		<a href="{{ url('images/customer', $customer->pan_no_img) }}" target="_blank" class="grid-item" style="float: right;">PAN No Document</a>
				            ...
				            @endif
				             ...
				             @if($customer->comp_doc)
				                <tr>
				                	<th>{{ trans('Company Name') }}: </th>
				                	<td>{{ $customer->comp_doc }}
				                		<a href="{{ url('images/customer', $customer->comp_doc_img) }}" target="_blank" class="grid-item" style="float: right;">Company Document</a>
