...
@section('content')
	@can('create', App\Inventory::class)
		<a href="{{ url('admin/stock/marketplace-listing-create') }}" class="ajax-modal-btn btn btn-default btn-flat">Upload Listings</a>
		...
		<div class="nav-tabs-custom">
			...
			<div class="tab-content">
			    <div class="tab-pane {{ Request::has('tab') ? '' : 'active' }}" id="active_inventory_tab">
					<table class="table table-hover" id="marketplace_listing_id1">
						<thead>
							<tr>
