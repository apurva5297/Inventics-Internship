<div class="row">
  ...
  <div class="col-md-4 nopadding-right">
    <div class="form-group">
      {!! Form::label('master_category', trans('Master category').'*', ['class' => 'with-help']) !!}
      {!! Form::select('master_cat_id', $master_cat, null, ['class' => 'form-control select2-normal', 'placeholder' => trans('master_category')]) !!}
      <div class="help-block with-errors"></div>
    </div>
  </div>
