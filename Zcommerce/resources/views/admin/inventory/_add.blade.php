<div class="box collapsed-box">
	<div class="box-header with-bcart">
		...
		<div class="box-tools pull-right">
			<a href="{{ route('admin.stock.inventory.fsn.mapping.page','Attribute?marketplace_id='.'1') }}" class="ajax-modal-btn btn btn-default btn-flat">{{ trans('csv import for mapping') }}</a>
