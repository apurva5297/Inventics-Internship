<div class="modal-dialog modal-md">
    <div class="modal-content">
    	{!! Form::open(['route' => 'admin.stock.inventory.fsn.mapping.upload', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-9 nopadding-right">
                    ...
                    <input type="hidden" name="marketplace_id" value="{{$marketpalce_id}}">
                </div>
                <div class="col-md-3 nopadding-left">
                    <div class="fileUpload btn btn-primary btn-block btn-flat">
                      <span>{{ trans('app.form.select') }} CSV</span>
                      <input type="file" name="inventory" id="uploadBtn" class="upload" />
                    </div>
                </div>
            </div>
        </div>
