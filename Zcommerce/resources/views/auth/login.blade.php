...
@section('content')
    <div class="login-logo">
        <a href="">{{ trans('Login to Zcommerce') }}</a>
        <h4 style="color: #fff">Continue to your store</h4>
    </div>
    <div class="box login-box-body">
        <div class="box-header with-border">
          <!-- <h3 class="box-title">{{ trans('Login to Zcommerce') }}</h3>
        ...
        <div style="text-align: center;">New to Zcommerce ? <a class="btn btn-link" href="{{url('/register')}}">Get Started</a></div>
    </div>
