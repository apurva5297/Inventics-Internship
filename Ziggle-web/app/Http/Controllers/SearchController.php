...
class SearchController extends Controller
{
    ...
    public function findProducts(Request $request)
    {
        ...
        foreach($products as $product) {
            $p = DB::table('catalog_product')->select('id')->where('product_id',$product->id)->where('catalog_id',$catalog_id)->first();
           
            $results .= View::make('admin.catalogs._product_list', ['product' => $product,'catalog_id'=>$catalog_id,'p'=>$p])->render();
        }
