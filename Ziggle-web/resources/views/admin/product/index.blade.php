		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\Product::class)
					<a href="{{ route('admin.catalog.product.ethnicbazaar.getProducts') }}" class=" btn btn-new btn-flat"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.products') }}"  class="fa fa-sync"></i>Sync Products</a>
